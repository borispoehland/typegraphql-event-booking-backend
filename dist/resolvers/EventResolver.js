...
var EventResolver = /** @class */ (function () {
    ...
    EventResolver.prototype.events = function () {
        return Event_1.Event.find({ relations: ['creator'] });
    };
    EventResolver.prototype.createEvent = function (data, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var event, userId, creator;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        event = Event_1.Event.create(data);
                        userId = ctx.userId;
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [CreateEventInput_1.CreateEventInput, Object]),
