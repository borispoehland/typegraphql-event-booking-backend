...
var EventResolver_1 = require("./resolvers/EventResolver");
var BookingResolver_1 = require("./resolvers/BookingResolver");
var auth_middleware_1 = __importDefault(require("./auth/auth-middleware"));
var auth_checker_1 = __importDefault(require("./auth/auth-checker"));
var path = '/graphql';
function bootstrap() {
                ...
                case 2:
                    ...
                    server = new apollo_server_express_1.ApolloServer({
                        ...
                        context: function (ctx) {
                            var _a = ctx.req, isAuth = _a.isAuth, userId = _a.userId;
