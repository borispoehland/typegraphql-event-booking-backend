...
var User = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        typeorm_1.OneToMany(function () { return Event_1.Event; }, function (event) { return event.creator; }),
        __metadata("design:type", Array)
    ], User.prototype, "createdEvents", void 0);
    __decorate([
        type_graphql_1.Field(function () { return [Booking_1.Booking]; }),
        typeorm_1.OneToMany(function () { return Booking_1.Booking; }, function (booking) { return booking.user; }),
        __metadata("design:type", Array)
